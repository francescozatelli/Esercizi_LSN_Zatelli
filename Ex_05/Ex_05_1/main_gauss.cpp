...
int main (int argc, char *argv[]){
	...
	double sigma100=0.760;
	double sigma210=1.880;
	...
	cout<<"Gaussian transition probability"<<endl<<endl;
	...
	cout<<"Standard deviation for 100: "<<sigma100<<endl;
	cout<<"Starting point for 100: ("<<xstart100<<", "<<ystart100<<", "<<zstart100<<")"<<endl;
	cout<<"Standard deviation step width for 210: "<<sigma210<<endl;
	...
	for(int i=0; i<M_eq;i++){
		p100.StepGauss(sigma210);
		p210.StepGauss(sigma210);
